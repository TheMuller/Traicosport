...
*/ 
	...
	*/
	...
	'PUBLIC'  =>  "Offentlig",
	'access:friends:label' => "Favorit Profiler",
	'access' => "Adgang", 
	...
	*/
	...
	'dashboard'  =>  "Trackpanel",
	'dashboard:nowidgets'  =>  "Med dit trackpanel kan du holde øje med streams og indhold der betyder noget for dig.",
	...
	*/
	...
	'friends'  =>  "Favorit profiler",
	'friends:yours'  =>  "Dine favorit profiler",
	'friends:owned'  =>  "%s's favorit profiler",
	'friend:add'  =>  "Følg profil",
	'friend:remove'  =>  "Fjern favorit profil",

	'friends:add:successful'  =>  "Du har føjet %s til dine favorit profiler.",
	'friends:add:failure'  =>  "Vi kunne ikke tilføje %s som en favorit profil. Prøv venligst igen.",
	
	'friends:remove:successful'  =>  "Du har fjernet %s fra dine favorit profiler.",
	'friends:remove:failure'  =>  "Vi kunne ikke fjerne %s fra dine favorit profiler. Prøv venligst igen.",
	
	'friends:none'  =>  "Denne bruger har ikke tilføjet nogen favorit profiler endnu.",
	'friends:none:you'  =>  "Du har ikke tilføjet nogen favorit profiler endnu!",
	 
	'friends:none:found'  =>  "Ingen favorit profiler fundet.",
	
	'friends:of:none'  =>  "Ingen har tilføjet denne bruger som favorit profil endnu.",
	'friends:of:none:you'  =>  "Ingen har tilføjet dig som favorit profil endnu. Begynd at tilføje indhold og udfylde din profil for at lade folk finde dig!",
	
	'friends:of:owned'  =>  "Folk der har føjet %s til deres favorit profiler",

	'friends:of' => "Favorit profiler for",
	'friends:collections'  =>  "Favorit liste",
	'collections:add' => "Ny liste", 
	'friends:collections:add'  =>  "Ny favoritliste",
	'friends:addfriends'  =>  "Tilføj favorit profiler",
	'friends:collectionname'  =>  "Listens navn", 
	'friends:collectionfriends'  =>  "Favorit profiler i listen",
	...
	'friends:collections:members' => "Favoritliste",
 ...
 */
	'river' => "River",
	'river:friend:user:default' => "%s har nu %s som favorit profil",
	...
	'river:none' => 'Ingen streams',
	'river:update' => 'Opdateret for %s',
	'river:delete:success' => 'Streams emne er blevet fjernet',
	'river:delete:fail' => 'Streams emne kunne ikke slettes',

	'river:widget:title' => "Stream",
	'river:widget:description' => "Vis seneste stream",
	'river:widget:type' => "Type af stream",
	'river:widgets:friends' => 'Favorit profilernes stream',
	'river:widgets:all' => 'TraicoStream',
 ...
 */
	...
	'search:go' => 'Go',
	'userpicker:only_friends' => 'Kun favorit profiler',
...
'Velkommen til Elgg! Lige nu kigger du på administrationsdelens trackpanel. Det er nyttigt til give overblik over, hvad der sker på sitet.',
 ...
 */
	...
	'river:mine' => 'Min stream',
	'river:friends' => 'Favorit profilers stream',
	'river:select' => 'Vis %s',
	'river:comments:more' => '+%u mere',
	'river:generic_comment' => 'kommenterede %s %s',

	'friends:widget:description' => "Vis nogle af dine favorit profiler.",
	'friends:num_display' => "Antal favorit profiler der skal vises",
...
*/ 	
	...
	'friend:newfriend:subject'  =>  "%s har gjort dig til favorit profil!",
	'friend:newfriend:body'  =>  "%s har gjort dig til favorit profil!
