...
function event_calendar_init() {
  ...
  // register our widget
  elgg_register_widget_type('event_calendar', elgg_echo('event_calendar:widget_title'), elgg_echo('event_calendar:widget:description'), 'profile,dashboard,groups,index', TRUE);
