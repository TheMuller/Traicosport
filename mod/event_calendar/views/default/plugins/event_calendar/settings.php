...
$event_calendar_currency = elgg_get_plugin_setting('currency', 'event_calendar');

$body .= elgg_echo('event_calendar:settings:currency:title');
$body .= '<br />';
$body .= elgg_view('input/text',array('name'=>'params[currency]','value'=>$event_calendar_currency));

$body .= '<br />';


$body .= elgg_echo('event_calendar:settings:payment:merchantnumber');
$body .= '<br />';
$body .= elgg_view('input/text',array('name'=>'params[merchantnumber]','value'=>elgg_get_plugin_setting('merchantnumber', 'event_calendar')));

$body .= '<br />';


$body .= elgg_echo('event_calendar:settings:payment:md5secret');
$body .= '<br />';
$body .= elgg_view('input/text',array('name'=>'params[md5secret]','value'=>elgg_get_plugin_setting('md5secret', 'event_calendar')));
