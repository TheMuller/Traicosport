...
%s
	...
	*/
    ...
    //Regions
    'event_calendar:region:Australia' => "Australia",
    'event_calendar:region:Belgium' => "Belgium",
    'event_calendar:region:Denmark' => "Denmark",
    'event_calendar:region:France' => "France",
    'event_calendar:region:Germany' => "Germany",
    'event_calendar:region:Ireland' => "Ireland",
    'event_calendar:region:Italy' => "Italy",
    'event_calendar:region:Luxembourg' => "Luxembourg",
    'event_calendar:region:Netherlands' => "Netherlands",
    'event_calendar:region:Norway' => "Norway",
    'event_calendar:region:Portugal' => "Portugal",
    'event_calendar:region:Russian Federation' => "Russian Federation",
    'event_calendar:region:Spain' => "Spain",
    'event_calendar:region:Sweden' => "Sweden",
    'event_calendar:region:United Kingdom' => "United Kingdom",
    'event_calendar:region:United States' => "United States",

    //Types
    'event_calendar:type:Training' => "Training",
    'event_calendar:type:Match' => "Match",
    'event_calendar:type:Tournament' => "Tournament",
    'event_calendar:type:Party' => "Party",
    'event_calendar:type:Course' => "Course",
    'event_calendar:type:Show' => "Show",
