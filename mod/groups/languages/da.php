 ...
 */
	...
	'groups:search_in_group' => "Søg i denne gruppe",
	'groups:acl' => "Gruppe: %s",

	'discussion:notification:topic:subject' => 'Ny gruppe diskussion startet',
	'groups:notification' =>
'%s har startet en ny diskussion til %s:

%s
%s

Vis og svar på diskussionen:
%s
',

	'discussion:notification:reply:body' =>
'%s svaret på diskussionsemnet %s i gruppen %s:
...
*/
	...
	'groups:access:group' => 'Kun for gruppemedlemmer',
...
*/
	...
	*/
	...
	'discussion:none' => 'Ingen diskussioner',
	'discussion:reply:title' => 'Svaret af %s',
