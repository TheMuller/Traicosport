<?php
	...
	*/
	...
	$danish = array(
		...
		'profile_manager:settings:view_profile' => 'Vis Profil',
		'profile_manager:settings:other' => 'Andet',
		...
		'widgets:register:loggedout' => "Du skal være logget ude for at bruge denne widget",
	
		// datepicker		
		'profile_manager:datepicker:trigger' => 'Vælg en dato',
		...
		'profile_manager:input:multi_select:empty_text' => 'Vælg venligst ...',
	
		// Edit profile => profile type selector
		'profile_manager:profile:edit:custom_profile_type:label' => "Vælg din profiltype",
		'profile_manager:profile:edit:custom_profile_type:description' => "Beskrivelse af valgte profiltype",
		'profile_manager:profile:edit:custom_profile_type:default' => "Standard",
	
		// non_editable
		'profile_manager:non_editable:info' => 'Dette felt kan ikke ændres.',
		
		// register form mandatory notice
		'profile_manager:register:mandatory' => "Felter med * er obligatoriske",

		// register profile icon
		'profile_manager:register:profile_icon' => 'This site requires you to upload a profile icon',
		
		// register accept terms
		'profile_manager:registration:accept_terms' => "Jeg har hermed accepterer betingelserne %sTerms of Service%",
	
		// simple access control
		'profile_manager:simple_access_control' => 'Vælg hvem der må se din profil informationer',
	
		// register pre check
		'profile_manager:register_pre_check:missing' => 'Følgende felt skal udfyldes: %s',
		'profile_manager:register_pre_check:profile_icon:error' => 'Fejl ved upload af dit profilbillede (sandsynligvis for stor en fil)',
		'profile_manager:register_pre_check:profile_icon:nosupportedimage' => 'Filtypen på dit profilbillede, som du ønsker at uploade er ikke korrekt (skal være jpg, gif, png)',
		...
		'profile_manager:account:username:button' => "Klik her for at ændre brugernavnet",
		'profile_manager:account:username:info' => "Ændre brugernavnet. Et billedeikon vil fortælle dig, om brugernavnet er optaget og gyldigt eller ej.",
		
		// river events
		'river:join:site:default' => '%s har tilmeldt sig siden',
