<?php
$frontleft=elgg_get_plugin_setting('frontleft','traico2_theme');
if (!$frontleft) $frontleft = '<div id="slider_da">
                                    ...
                                    <div class="panel-container">
                                      <div id="register_da" class="accordion_child">
                                          <div>
                                            <p class="register" style="margin:10px 0;">
                                                <a href="http://traicosport.com/da/register">
                                          ...
                                          <div id="login_with_facebook">
                                          	...
                                          	<a href="https://www.facebook.com/login.php?api_key=252770421408236&cancel_url=http%3A%2F%2Ftraicosport.com%2Fda%2F&display=page&fbconnect=1&next=http%3A%2F%2Ftraicosport.com%2Fda%2Ffacebook_connect%2Flogin&return_session=1&session_version=3&v=1.0&req_perms=user_status%2Cpublish_stream%2Cemail%2C">
                                                  <img src="http://traicosport.com/images/logo_facebook.jpg" alt="Facebook" />
                                              </a>
                                          </div>
                                          <div id="login_with_twitter">
                                          	<a href="http://traicosport.com/da/twitter_api/forward">
                                      ...
                                      <div id="idea_da" class="accordion_child">
                                        ...
                                        <p>
                                            ...
                                            <a href="http://www.traicosport.com/da/register.php">Opret en gratis profil</a>, og start med at komme i kontakt med andre personer indenfor den sportsgren du holder af..</p>
        ...
        <div id="view_footer">
            <ul>
                ...
                <li><a href="http://www.traicosport.com/da/terms">Betingelser</a></li>
                <li><a href="http://www.traicosport.com/da/privacy">Privat indhold</a></li>
                <li>Sprog: <a href="http://traicosport.com/da/#en">Engelsk</a></li>
            </ul>
        </div>
    ...
    <div id="en">
      <div class="elgg-page elgg-page-default">
        	...
        	<div class="elgg-page-header">
        		<div class="elgg-inner">
                    <div id="logo"><a href="http://traicosport.com/da/#en"><img border="0" alt="Traicosport" src="http://traicosport.com/images/logo.png"></a></div>
                </div>
        	</div>
                                  ...
                                  <div class="panel-container">
                                    ...
                                    <div id="idea" class="accordion_child">
                                      ...
                                      <p>
                                          ...
                                          <a href="http://www.traicosport.com/da/register.php">Create a profile for free</a>, and start to get in touch with others in the sport you love..</p>
                                      <p style="margin-top:20px;">Velkommen til Danmarks Sportsportal!</p>
                                      <p>Start sporting!<br />Team Traicosport</p>
                                      <p>
      ...
      <div id="view_footer">
          <ul>
              ...
              <li><a href="http://www.traicosport.com/da/terms">Terms</a></li>
              <li><a href="http://www.traicosport.com/da/privacy">Privacy</a></li>
              <li>Language: <a href="http://traicosport.com/da/">Danish</a></li>
          </ul>
      </div>


';
$frontright=elgg_get_plugin_setting('frontright','traico2_theme');
...
<style>
.elgg-page-body {
	background:url(<?php echo $vars['url']; ?>mod/traico2_theme/graphics/index.png) top left repeat-x;
	min-height:591px;
	margin-top:50px;
	}
</style>
